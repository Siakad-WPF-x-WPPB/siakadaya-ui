...
$(function () {
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              // '</div>' +
              '<div class="d-flex">' +
              '<a href="/admin/ruangan/' + full.id + '/edit" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ti ti-pencil ti-md"></i></a>' +
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function () {
            window.location = '/admin/ruangan/create';
          }
        }
      ],
      responsive: {
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Tabel Ruangan</h5>');
  }
  ...
  $('.datatables-basic tbody').on('click', '.item-destroy', function () {
    ...
    if (confirm('Are you sure you want to delete this record?')) {
      ...
      $.ajax({
        url: '/api/ruangan/destroy/' + id,
        type: 'DELETE',
        success: function (response) {
          // Show success message
          // toastr.success(response.message || 'Data program studi berhasil dihapus.');
          alert(response.message || 'Data program studi berhasil dihapus.');
