...
$(function () {
    ...
    dt_basic = dt_basic_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              // '</div>' +
              '<div class="d-flex">' +
              '<a href="/admin/program-studi/' + full.id + '/edit" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ti ti-pencil ti-md"></i></a>' +
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function () {
            window.location = '/admin/program-studi/create';
          }
        }
      ],
      responsive: {
  ...
  $('.datatables-basic tbody').on('click', '.item-destroy', function () {
    ...
    if (confirm('Are you sure you want to delete this record?')) {
      ...
      $.ajax({
        url: '/api/program-studi/destroy/' + id,
        type: 'DELETE',
