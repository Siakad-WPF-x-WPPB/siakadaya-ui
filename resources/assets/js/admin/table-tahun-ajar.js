...
$(function () {
  ...
  if (dt_basic_table.length) {
    dt_basic = dt_basic_table.DataTable({
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              // '</div>' +
              '<div class="d-flex">' +
              '<a href="/admin/tahun-ajar/' + full.id + '/edit" class="btn btn-sm btn-text-secondary rounded-pill btn-icon item-edit"><i class="ti ti-pencil ti-md"></i></a>' +
      ...
      buttons: [
        ...
        },
        {
          ...
          action: function () {
            window.location = '/admin/tahun-ajar/create';
          }
        }
      ],
      responsive: {
    ...
    $('div.head-label').html('<h5 class="card-title mb-0">Tabel Tahun Ajar</h5>');
  }
