      ...
      <form id="formAccountSettings" method="POST"
        ...
        <div class="row mb-6">
          ...
          <div class="col-md-4">
            ...
            <div class="col-sm-12">
              <input type="time" id="jam-selesai" name="jam_selesai" value="{{ $jadwal->jam_selesai ?? old('jam_selesai') }}" class="form-control flatpickr-basic @error('jam_akhir') is-invalid @enderror" placeholder="Jam Mulai" />
              @error('jam_selesai')
                <div class="invalid-feedback d-block">
                  {{ $message }}
                </div>
