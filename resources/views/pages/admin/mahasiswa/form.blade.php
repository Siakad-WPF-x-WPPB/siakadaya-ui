...
@section('content')
    <div class="col-xxl">
        <div class="card mb-6">
            ...
            <div class="card-body">
                <form id="formAccountSettings" method="POST" action="{{ route('admin-mahasiswa-store') }}"
                            ...
                            <div class="col-sm-12">
                                <div class="input-group input-group-merge">
                                    <input type="text" id="email" name="email" class="form-control"
                                        placeholder="adrian@it.student.pens.ac.id" aria-label="john.doe"
                                        aria-describedby="email2" value="{{ old('email') }}" />
                        ...
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="nrp" type="text" class="form-control" id="nrp"
                                    placeholder="3123500038" value="{{ old('nrp') }}" />
                            </div>
                        </div>
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="nama" type="text" class="form-control" id="nama"
                                    placeholder="Denis Beban" {{ old('nama') }} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <select name="jenis_kelamin" id="jenis-kelamin" class="select2 form-select"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="telepon" type="text" id="telepon" class="form-control phone-mask"
                                    placeholder="0895301391873" aria-label="0895301391873"
                                    aria-describedby="basic-default-phone" {{ old('telepon') }} />
                            </div>
                        </div>
                        <div class="col-md-6 mb-6">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="tanggal_lahir" type="text" id="tanggal-lahir"
                        ...
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="tanggal_masuk" type="text" id="tanggal-masuk"
                                    class="form-control dob-picker" placeholder="YYYY-MM-DD"
                                    {{ old('tanggal_masuk') }} />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="alamat_jalan" type="text" class="form-control" id="alamat-jalan"
                                    placeholder="Jl. Raya Keputih" {{ old('alamat_jalan') }} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <select name="provinsi" id="provinsi" class="select2 form-select"
                                    data-allow-clear="true">
                                    <option value="">Select</option>
                        ...
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="kode_pos" type="text" class="form-control" id="kode-pos"
                                    placeholder="123456" {{ old('kode_pos') }} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <select name="negara" id="negara" class="select2 form-select"
                                    data-allow-clear="true">
                                    <option value="">Select</option>
                        ...
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="kelurahan" type="text" class="form-control" id="kelurahan"
                                    placeholder="Desa Keputih" {{ old('kelurahan') }} />
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-6">
                            ...
                            <div class="col-sm-12">
                                <input name="kecamatan" type="text" class="form-control" id="kecamatan"
                                    placeholder="Sukolilo" {{ old('kecamatan') }} />
                            </div>
                        </div>
                        <div class="col-md-6 mb-6">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 d-grid">
                            <a href="{{ route('admin-mahasiswa-index') }}" type="reset"
